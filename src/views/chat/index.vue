...
const Recharge = defineAsyncComponent(() => import('@/components/Recharge/index.vue'))
...
<template>
  <div class="flex flex-col w-full h-full">
    ...
    <footer :class="footerClass">
      <div class="w-full max-w-screen-xl m-auto">
        <div class="flex items-center justify-between space-x-2">
          <HoverButton v-if="!isMobile" tooltip="充值" @click="show = true">
            <span class="text-xl text-[#FF8000]">
              <SvgIcon icon="ri:shopping-cart-fill" />
            </span>
          </HoverButton>
    ...
    <Recharge v-if="show" v-model:visible="show" />
  </div>
</template>
